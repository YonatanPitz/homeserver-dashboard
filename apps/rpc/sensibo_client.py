...
class SensiboClientAPI(object):
    ...
    def pod_change_ac_state(self, podUid, newAcState):
        self._post("/pods/%s/acStates/" % (podUid),
                json.dumps({'acState': newAcState}))
        
    def pod_change_ac_property(self, podUid, currentAcState, propertyToChange, newValue):
